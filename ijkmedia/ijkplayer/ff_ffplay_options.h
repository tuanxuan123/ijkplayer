...
static const AVOption ffp_context_options[] = {
    ...
    { "start-time",                  "set offset of player should be seeked",
        OPTION_OFFSET(start_time),       OPTION_INT64(0, 0, INT_MAX) },
    { "end-time",                       "play end time in millisecond",
        OPTION_OFFSET(end_time),       OPTION_INT64(0, 0, INT_MAX) },
    ...
    { "mediacodec-surface",                     "MediaCodec: config surface",
        OPTION_OFFSET(mediacodec_surface),          OPTION_INT(0, 0, 1) },
    ...
    { "aaudio",                           "AAudio: enable",
      OPTION_OFFSET(aaudio),            OPTION_INT(0, 0, 1) },
    ...
    { "xaudio2",                              "xaudio2: enable",
        OPTION_OFFSET(xaudio2),               OPTION_INT(0, 0, 1) },
    { "atmos-eac3",                           "atmos eac3: enable",
        OPTION_OFFSET(atmos_eac3),            OPTION_INT(0, 0, 1) },
    { "play-audio",                           "play audio: enable",
        OPTION_OFFSET(play_audio),            OPTION_INT(1, 0, 1) },
    { "open-mediacodec-max-input-size",       "open mediacodec max-input-size: open",
        OPTION_OFFSET(open_max_input_size),   OPTION_INT(1, 0, 1) },      
    { "only-play-type",                       "only play type: enable",
        OPTION_OFFSET(only_play_type),        OPTION_INT(0, 0, 2) }, 
    { "audio-stop-mode",                      "audio-stop-mode: async",
        OPTION_OFFSET(audio_stop_mode),       OPTION_INT(1, 0, 1) },
    { "only-play-api",                        "only-play-api: no",
        OPTION_OFFSET(only_play_api),         OPTION_INT(0, 0, 1) },
    { "no-message",                           "no-message: no",
        OPTION_OFFSET(no_message),            OPTION_INT(0, 0, 1) },
    { NULL }
};
