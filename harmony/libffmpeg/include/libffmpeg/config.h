...
#define FFMPEG_CONFIGURATION "--arch=arm64 --enable-yasm --enable-openssl --enable-libvorbis --disable-gpl --disable-nonfree --enable-libvorbis --enable-openssl --disable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --disable-swscale --disable-postproc --disable-avfilter --disable-avresample --disable-w32threads --enable-network --disable-hwaccels --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder='pcm*' --enable-decoder=hevc --enable-decoder=mpeg4 --enable-decoder=libvorbis --enable-decoder=eac3 --disable-muxers --enable-muxer=mp4 --enable-muxer=mpegts --enable-demuxer=matroska --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=mpegvideo --enable-demuxer=hevc --enable-demuxer=ogg --enable-demuxer=wav --enable-demuxer=eac3 --enable-demuxer=ijklivehook --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=hevc --enable-parser=ac3 --disable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-protocols --enable-protocol=async --enable-protocol=file --enable-protocol=hls --enable-protocol=http --enable-protocol=https --enable-protocol=rtmp --enable-protocol=ftp --enable-protocol=ffrtmphttp --enable-protocol=tcp --enable-protocol=pipe --enable-protocol=tls_openssl --enable-protocol=ijksegment --enable-protocol=ijkio --enable-protocol=ijkhttphook --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --disable-zlib --prefix=/Users/xanderdeng/pixui_ijkplayer/harmony/build/ffmpeg-arm64/output --enable-cross-compile --target-os=linux --enable-pic --disable-x86asm --disable-shared --enable-static --enable-optimizations --disable-debug --enable-small --enable-stripping --sysroot=/Users/xanderdeng/Library/openharmony/9/native/sysroot --cc=/Users/xanderdeng/Library/openharmony/9/native/llvm/bin/clang --cxx=/Users/xanderdeng/Library/openharmony/9/native/llvm/bin/clang++ --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DNDEBUG -I/Users/xanderdeng/pixui_ijkplayer/harmony/openssl/include -I/Users/xanderdeng/pixui_ijkplayer/harmony/libvorbis/include -march=armv8-a --target=aarch64-linux-ohos -s -s' --extra-ldflags=' -L/Users/xanderdeng/pixui_ijkplayer/harmony/openssl/lib/arm64 -lssl -lcrypto -L/Users/xanderdeng/pixui_ijkplayer/harmony/libvorbis/lib/arm64 -lvorbis -logg -lm -march=armv8-a --target=aarch64-linux-ohos'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/xanderdeng/pixui_ijkplayer/harmony/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/xanderdeng/pixui_ijkplayer/harmony/build/ffmpeg-arm64/output/share/ffmpeg"
#define CC_IDENT "OHOS (dev) clang version 12.0.1 (llvm-project 1971c85d809b8dd102ede1ec71208518a9b0f68e)"
