...
#ifdef _UWIN
#   define HAVE_STRUCT_pthread_timespec 1
...
#ifndef HAVE_STRUCT_pthread_timespec
#define HAVE_STRUCT_pthread_timespec 1
struct pthread_timespec {
        long tv_sec;
        long tv_nsec;
};
#endif /* HAVE_STRUCT_pthread_timespec */
...
#if defined(PTW32_LEVEL) && defined(PTW32_LEVEL_MAX)
#if PTW32_LEVEL >= PTW32_LEVEL_MAX
...
PTW32_DLLPORT int PTW32_CDECL pthread_mutex_timedlock(pthread_mutex_t *mutex,
                                    const struct pthread_timespec *abstime);
 ...
 */
PTW32_DLLPORT int PTW32_CDECL pthread_delay_np (struct pthread_timespec * interval);
